...
===================== */
var computedValue;
p = $.ajax(phillyCrimeDataUrl);
p.done(function(data) {
    computedValue = JSON.parse(data)
    _.each(_.allKeys(computedValue), function(key) {L.marker([computedValue[key].Lat, computedValue[key].Lng]).addTo(map)});
});
